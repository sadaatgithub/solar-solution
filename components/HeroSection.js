...
const HeroSection = () => {
  return (
    ...
    flex flex-col justify-center items-center text-white  relative after:content-[''] after:absolute after:bg-black/70  after:inset-0">
        <div className="md:w-[70%] text-center flex flex-col gap-6 z-10 mt-28">
        <h1 className='text-4xl md:text-6xl font-bold uppercase'>Power your home with clean, affordable solar energy</h1>
        ...
        <div className="text-center flex gap-4 justify-center pt-4 flex-col md:flex-row [&>button:hover]:-translate-y-2 ">
            <button className='border border-orange-500 px-6 py-3 bg-orange-500 rounded-sm transition-all duration-200'>Get Free Quote</button>
            <button className='border px-6 py-3 rounded-sm transition-all duration-200'>Know More</button>
        </div>
        </div>
