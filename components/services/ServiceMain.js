  ...
  return (
    ...
    <m.div variants={fadeIn('right','tween',0.1,0.5)} initial="hidden" whileInView="show" viewport={{once:true, amount:0.3}} className="xl:w-[45%] flex flex-col border md:w-/3 overflow-hidden  rounded-md">
      ...
      <div className="p-6 bg-white">
        <h3 className="font-bold pb-6 text-[40px] text-gray-700 ">Solar Work</h3>
        ...
        <div className="pt-8">
          <button className="text-green-500"><Link href="/services/solar-work">Read More</Link></button>
        </div>
      </div>
    </m.div>
    <div className="flex flex-col xl:w-[55%] gap-8 ">
      ...
      {/* service two */}
        ...
        <m.div variants={fadeIn('down','tween',0.2,0.5)} initial="hidden" whileInView="show" viewport={{once:true, amount:0.3}} className="border  rounded-md p-6 w-full xl:w-1/2 flex flex-col">
          ...
          <h5 className="pb-2 text-2xl font-bold text-gray-700">HT-LT panels</h5>
          <p className="text-gray-500">We offers installation and maintenance services for both LT and HT solar systems</p>
          <div className="pt-6 mt-auto">
            <button className="text-green-500"><Link href="/services/ht-lt-panels">Read More</Link></button>
          </div>
        </m.div>
      ...
      {/* service three */}
        <m.div variants={fadeIn('left','tween',0.3,0.5)} initial="hidden" whileInView="show" viewport={{once:true, amount:0.3}} className=" border rounded-md p-6 w-full xl:w-1/2 bg-white">
          ...
          <h5 className="pb-2 text-2xl font-bold text-gray-700 ">Consultant</h5>
          ...
          <div className="pt-6">
            <button className="text-green-500"><Link href="/services/consultant">Read More</Link></button>
          </div>
        </m.div>
      </div>
    ...
    <m.div variants={fadeIn('up','tween',0.4,0.5)} initial="hidden" whileInView="show" viewport={{once:true, amount:0.1}} className="flex flex-col-reverse h-full border sm:flex-row bg-white  rounded-md">
        ...
        <h5 className="pb-2 text-2xl font-bold text-gray-700 mt-auto">Solar Equipments Supply</h5>
        <p className="text-gray-500">Streamlined Material Supply for Reliable Solar Installations</p>
        <div className="pt-6 mt-auto">
            <button className="text-green-500"><Link href="/services/solar-material-supply">Read More</Link></button>
        </div>
